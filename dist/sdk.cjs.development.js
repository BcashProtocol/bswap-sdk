...
var IBSwapV1Pair = _interopDefault(require('@bswap/core/build/IBSwapV1Pair.json'));
...
var FACTORY_ADDRESS = '0x5512a15086eea286be1a98ad7c6c8d884382457d';
var INIT_CODE_HASH = '0x53944d4402fd207356cc1e62c10c0ab9789aa2c7cb290bab430ef70c5e03743d';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'BSCX', 'bswap LP Token');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IBSwapV1Pair.abi, provider).getReserves()).then(function (_ref) {
